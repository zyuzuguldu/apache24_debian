...
if [ ! -f "${APR_FILE}" ]
then
	wget http://ftp.itu.edu.tr/Mirror/Apache//apr/${APR_FILE}
	tar xvfz ${APR_FILE}
...
if [ ! -f "${APRU_FILE}" ]
then
	wget http://ftp.itu.edu.tr/Mirror/Apache//apr/${APRU_FILE}
	tar xvfz ${APRU_FILE}
...
if [ ! -f "${APRI_FILE}" ]
then
	wget http://ftp.itu.edu.tr/Mirror/Apache//apr/${APRI_FILE}
	tar xvfz ${APRI_FILE}
